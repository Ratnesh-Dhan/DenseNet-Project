...
def create_dataset(tfrecord_path):
    ...
    dataset = dataset.repeat(3)  # Repeat the dataset for multiple epochs
...
def train_model():
    ...
    try:
        ...
        model_path = 'mask_model_weights.weights.h5'  # FIXED: Changed .keras to .weights.h5
...
if __name__ == "__main__":
    ...
    try:
        ...
        if model is not None:
            ...
            # Save final model weights - FIXED: Changed .keras to .weights.h5
            model.save_weights('final_mask_model_weights.weights.h5')
            print("Final weights saved to final_mask_model_weights.weights.h5")
