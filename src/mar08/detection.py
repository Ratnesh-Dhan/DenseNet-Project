...
model_path = "best_segmentation_model_b7.h5"  # Use the path to your best saved model
...
# def segment_directory(directory_path, model, output_dir=None):
...
if __name__ == "__main__":
    ...
    image_path = "../img/bus.jpg"  # Replace with path to your test image
