...
MODEL_PATH = "./newModel/final_model.keras"   # or best_phase1 / best_phase2a / best_phase2b
IMAGE_PATH = "../inference/images/28.jpeg"
...
fig.suptitle(
    f"{IMAGE_PATH}  |  coverage: {coverage:.2f}%  conf: {mean_conf:.3f}",
    fontsize=12
)
