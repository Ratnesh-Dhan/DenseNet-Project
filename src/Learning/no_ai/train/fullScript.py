...
path_images = "/mnt/d/Code/DenseNet-Project/Datasets/Traffic_Dataset/images/train/"
path_annot = "/mnt/d/Code/DenseNet-Project/Datasets/Traffic_Dataset/labels/train/"
...
# In our case, the bbox and classes lists have different lengths for each image, depending on the 
# number of objects in the image and the corresponding bounding boxes and classes.
