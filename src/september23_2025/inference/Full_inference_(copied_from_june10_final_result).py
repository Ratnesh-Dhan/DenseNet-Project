...
## for 16 x 16 patch size
# def sliding_window_inference(model, image, window_size=16, stride=16, center_patch_size=16):
# for 30x30 patch size
def sliding_window_inference(model, image, window_size=30, stride=30, center_patch_size=30):
    cavity_green = 0
    ...
    return cavity_green, cavity_filled_blue, inertinte_red, mineral_yellow, vitrinite_purple

adadelta = "../models/adadelta/EarlyStoppedBestadadelta.keras"
adagrad = "../models/adagrad/EarlyStoppedBestadagrad.keras"
rmsprop = "../models/rmsprop/EarlyStoppedBestrmsprop.keras"
nadam = "../models/nadam/EarlyStoppedBestnadam.keras"
model_ary = [nadam]
    ...
    with open(os.path.join(result_folder, "final_output.txt"), 'w') as f:
        ...
        for outer_folder in outer_folders:
            ...
            for file_name in files:
                ...
                cavity, cavity_filled, inertinite, minerals, vitrinite = sliding_window_inference(model, img)
