...
# ====================== CONFIG ======================
MODEL_PATH = "/mnt/d/Codes/DenseNet-Project/src/steel_defect_oct_2025/train/pytorch/models/ssd_model_better_early_stopping_best.pth"
...
OUTPUT_DIR = "./results/predictions3"
...
if __name__ == "__main__":
    ...
    test_folder = "/mnt/d/Codes/DenseNet-Project/Datasets/NEU-DET/images/test"
    ...
    if os.path.exists(test_folder):
        all_predictions = predict_on_folder(
            ...
            classes, 
            SCORE_THRESHOLD,
            max_images=138  # Limit to first 20 images (remove for all)
        )
